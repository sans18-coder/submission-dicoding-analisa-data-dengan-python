...
dataframe = pd.read_csv("Dashboard/data_clear.csv")
...
plt.barh(y=name_category_product, width=top_10_category_product,)
...
plt.barh(y=nama_kota_terbanyak, width=top_10_customer_city)
plt.ylabel("City")
